...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :session_key => '_playdate_session',
    :secret      => 'change this to your own secret'
  }
...
ActiveRecord::Errors.default_error_messages[:too_long] = " is te lang (maximum is %d tekens)" 
ActiveRecord::Errors.default_error_messages[:too_short] = " is te kort (minimum is %d tekens)" 
